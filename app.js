...
if (isPdf(path) && isPhone()) {
  ...
  contentFrameWrap.innerHTML = `
    <div class="emptyState" style="line-height:1.55;">
      ...
      첫 페이지만 보이거나 넘김이 막히는 경우가 있습니다.<br/><br/>
...
function isPhone() {
  // iOS / Android 상관없이 "핸드폰 크기"면 전부 폰 처리
...
function renderFileList(files) {
  ...
  // 모바일 드롭다운 버튼에 선택된 제목 표시
  if (fileDropdownLabel) {
    fileDropdownLabel.textContent = b.textContent;
  }
...
// 모바일 파일 목록 드롭다운 버튼 이벤트 (여기에 추가!)
fileDropdownBtn?.addEventListener("click", () => {
